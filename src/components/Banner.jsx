    ...
    <div className='px-4 lg:px-24 bg-teal-100 flex items-center'>
        <div className='w-full flex flex-col md:flex-row justify-between items-center gap-12 py-40'>
            <div className='md:w-1/2 space-y-7 h-full'>
                ...
                <p className='md:w-4/5'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Harum odit est odio ex perspiciatis? Mollitia modi, error accusantium impedit quos illo similique velit culpa enim quae, omnis vitae iure. Fuga.`</p>
                <div>
